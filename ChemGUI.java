...
public class ChemGUI {
	...
	public void outerCreation() {
		String[] equations = { "Boyle's Law", "Percent Yield", "Temperature",
				"Ideal Gas Equation", "Potential Energy", "Molarity",
				"Electron Energy, nth State", "Photon Energy",
	...
	public void listeners() {
		...
		calculateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case "Boyle's Law":
					ans = String.valueOf(eq.boylesPandV(c1, c2, c3, c4));
					break;
				case "Percent Yield":
					ans = String.valueOf(eq.percentYield(c1, c2, c3));
					break;
				case "Temperature":
					if (c1 != null) {
						Double d1 = eq.toCe(c3, c1);
						Double d2 = eq.toFa(c2, c1);
						ans = "Ce: " + String.valueOf(d1) + "; Fe: "
								+ String.valueOf(d2);
					}
					if (c2 != null) {
						Double d1 = eq.toKe(c3, c2);
						Double d2 = eq.toFa(c2, c1);
						ans = "Ke: " + String.valueOf(d1) + "; Fe: "
								+ String.valueOf(d2);

					}
					if (c3 != null) {
						Double d1 = eq.toCe(c3, c1);
						Double d2 = eq.toKe(c3, c2);
						ans = "Ce: " + String.valueOf(d1) + "; Ke: "
								+ String.valueOf(d2);

					}
					break;
				case "Ideal Gas Equation":
					ans = String.valueOf(eq.idealGasEqu(c1, c2, c3, c4));
					break;
				case "Potential Energy":
					ans = String.valueOf(eq.potentialEnergy(c1, c2, c3, c4));
					break;
				case "Molarity":
					ans = String.valueOf(eq.molarity(c1, c2, c3));
					break;
				case "Electron Energy, nth State":
					ans = String.valueOf(eq.equation2(c1, c2));
					break;
				case "Photon Energy":
	...
	public static void main(String[] args) {
		...
		ChemGUI calculator = new ChemGUI();
	}
}
